                                ...
                                <div class="app-page-title">
                                    <div class="page-title-wrapper">
                                        <div class="page-title-heading">
                                            ...
                                            <div>Add Products
                                                <div class="page-title-subheading">Add clothes and footwear to Daisy's Wardrobe.
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion1" id="collapseOne1" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="blue_clr_variation" placeholder="Ex: Pacific blue" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion2" id="collapseOne2" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="green_clr_variation" placeholder="Ex: light green" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion3" id="collapseOne3" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="gold_clr_variation" placeholder="Ex: dark gold" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion4" id="collapseOne4" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="silver_clr_variation" placeholder="Ex: litmus silver" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion5" id="collapseOne5" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="brown_clr_variation" placeholder="Ex: weawy brown" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion6" id="collapseOne6" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="black_clr_variation" placeholder="Ex: black shine" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion7" id="collapseOne7" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="yellow_clr_variation" placeholder="Ex: Busted yellow" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion8" id="collapseOne8" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="red_clr_variation" placeholder="Ex: light red" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion9" id="collapseOne9" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="purple_clr_variation" placeholder="Ex: Light purple" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion10" id="collapseOne10" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="pink_clr_variation" placeholder="Ex: Dark pink" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion11" id="collapseOne11" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="orange_clr_variation" placeholder="Ex: Clean orange" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion12" id="collapseOne12" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="gray_clr_variation" placeholder="Ex: Night gray" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion13" id="collapseOne13" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="BnW_clr_variation" placeholder="Ex: black & white" class="col-6 form-control mb-3" />
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div data-parent="#accordion14" id="collapseOne14" aria-labelledby="headingOne" class="collapse" style="">
                                                                    <div class="card-body">
                                                                        ...
                                                                        <input type="text" name="" id="white_clr_variation" placeholder="Ex: Windy White" class="col-6 form-control mb-3" />
