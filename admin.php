                            ...
                            <div class="col-md-12 ">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 text-center card card-body col-12 col-md-6">
                                            <h5 class="card-title">Add Products</h5><span>You can add products to Daisy's Wardrobe.</span><br />
                                            <button onclick="goToAddProduct();" class="btn btn-focus"><i class="fa fa-wrench" aria-hidden="true"></i> &nbsp;&nbsp; Go To Add Product</button>
                                        </div>
                                        <div class="mb-3 text-center card card-body col-12 col-md-6">
                                            <h5 class="card-title">My Products</h5><span>You can see all products listed in Daisy's Wardrobe.</span><br />
