...
<head>
    ...
    <title>Daisy's Wardrobe | Home</title>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        ...
                                        <h1 style="color: white;" class="title">Hello, Welcome to <br> Daisy's Wardrobe </h1>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        ...
                                        <h1 style="color: white;" class="title">Newly Added<br> Footwear Section</h1>
                                        <a href="shop-grid-sidebar-left.php" class="btn btn-lg btn-white">shop now </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        ...
                                        <h1 style="color: white;" class="title">Introducing E-Pay along <br>With Cash On Delivery</h1>
                                        <a href="shop-grid-sidebar-left.php" class="btn btn-lg btn-white">shop now </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <div class="content">
                                ...
                                <p>Get 10% cash back, free returns, and more at 100+ top retailers!</p>
                            </div>
                        </div>
                    </div>
