...
<body style="background-image: url('assets/images/profilebackground.jpg'); background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
    ...
    <div class="container-fluid vh-100 justify-content-center">
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h1 class="text-center title1" style="font-family: 'calibri';">Welcome to <span class="text-danger">Daisy's Wardrobe</span> Admin Panel</h1>
            ...
            <p class="text-center">&copy;2022 Daisy's Wardrobe All Rights Reserved.</p>
