            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				...
            				<h3>Exiting news, deals, and updates right in your inbox</h3>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	...
                      	<p>Daisy's Wardrobe is owned by Lankesh Halangoda.</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">2No 363, D S Senanayake Street, Kandy</span></li>
					                <li><span class="text">+94767740385</span></a></li>
					              </ul>
                      </td>
                    </tr>
                  </table>
