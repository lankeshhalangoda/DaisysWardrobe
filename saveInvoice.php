...
if(isset($_SESSION["u"])){
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
    $mail->setFrom('sendmyemailstoyou@gmail.com', 'Daisy\'s Wardrobe');
    $mail->addReplyTo('sendmyemailstoyou@gmail.com', 'Daisy\'s Wardrobe');
    $mail->addAddress($ses_mail);
    $mail->isHTML(true);
    $mail->Subject = 'Daisy\'s Wardrobe Delivery Order Confirmation';
                      ...
                      <tr>
                        <td class="mobile-center" align="left" style="padding:40px 0;">
                          <div class="mobile-center" align="left"><!--[if mso]>
                            ...
                            <![endif]--><a href="https://daisyswardrobebylankesh.com"
                            style="background-color:black;background-image:url(https://icons8.com/icon/vn4JOzPBucqU/url);border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;text-shadow: -1px -1px #47A54B;line-height:38px;text-align:center;text-decoration:none;width:190px;-webkit-text-size-adjust:none;mso-hide:all;">Visit to Daisy\'s Wardrobe</a></div>
                        </td>
                      </tr>
                    </table>
