...
<head>
    ...
    <title>Daisy's Wardrobe | About Us</title>
            ...
            <div class="row d-flex align-items-center justify-content-between d-sm-column">
                ...
                <div class="col-md-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="200">
                        <h3 class="title">About Daisy's Wardrobe</h3>
                        <h5 class="semi-title">We are a leading clothing store in Kandy,
                            now expanded all over Sri Lanka through the newly introduced online delivery.
                        </h5>

                        <p>We mainly bring you the highest quality clothing and footwear manufactured under the world's leading brands.
                            We have all kinds of clothing and footwear to suit your taste.
                        </p>

                        <p>Latest fashion at an affordable price!� Join us today� 15x7 customer support �.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <div class="content">
                                ...
                                <p>Get 10% cash back, free shipping, free returns, and more at 100+ top retailers!</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="content">
                                <h6 class="title">03 DAYS MONEY BACK GUARANTEE</h6>
                                <p>100% satisfaction guaranteed, or get your money back within 03 days!</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Service Promo Single Item -->
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <div class="content">
                                ...
                                <p>Card for the other 30% of their purchases at a rate of 10% cash back.</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Service Promo Single Item -->
                        ...
                        <div class="offset-4 col-xl-4 mb-5">
                            <div class="team-single" data-aos="fade-up" data-aos-delay="0">
                                ...
                                <div class="team-content">
                                    <h6 class="team-name font--bold mt-5">Mr. Lankesh Halangoda</h6>
                                    <span class="team-title">CEO & FOUNDER</span>
                                    <ul class="team-social pos-absolute">
                                        <li><a href="https://www.facebook.com/reallankelk"><i class="ion-social-facebook"></i></a></li>
                                        <li><a href="https://www.linkedin.com/in/lankeshhalangoda"><i class="ion-social-linkedin"></i></a></li>
                                        <li><a href="https://www.twitter.com/lankelk"><i class="ion-social-twitter"></i></a></li>
                                        <li><a href="tel:+94767740385"><i class="ion-social-whatsapp"></i></a></li>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <br>
The Site is provided to you free of charge for your personal use, subject to these Terms and Conditions. By using the Site you agree to be bound by these Daisy's Wardrobe Terms and Conditions. These Terms and Conditions govern your use of the Site and all services provided in connection with these. All orders and purchases made on the Site will also be governed by the terms and conditions of Daisy's Wardrobe Online (Pvt) and that of the Global payments relating to online payments.
<br>
...
<br>
<br>
No license is granted to you in these Terms and Conditions to use any of our trademark(s) or our affiliated companies including, without limitation, the trademarks Daisy's Wardrobe Online (Pvt) Ltd
                </div>
